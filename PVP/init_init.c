...
if ( itemTop )
		{
			...
			string jacketArray[] = { "M65Jacket_Black", "M65Jacket_Khaki", "M65Jacket_Olive", "M65Jacket_Tan" };
			int rndIndex0 = Math.RandomInt(0, 3);
			jacket = player.GetInventory().CreateInInventory(jacketArray[rndIndex0]);
						
			//Création du pantalon
			string pantArray[] = { "CargoPants_Beige", "CargoPants_Black", "CargoPants_Blue", "CargoPants_Green", "CargoPants_Grey" };
			int rndIndex1 = Math.RandomInt(0, 4);
			pant = player.GetInventory().CreateInInventory(pantArray[rndIndex1]);
			...
			helmet = player.GetInventory().CreateInInventory(helmetArray[rndIndex2]);
			...
			mask = player.GetInventory().CreateInInventory(maskArray[rndIndex4]);
			...
			vest = player.GetInventory().CreateInInventory(vestArray[rndIndex5]);
			
			//Création des gants
			string glovesArray[] = { "TacticalGloves_Beige", "TacticalGloves_Black", "TacticalGloves_Green", "OMNOGloves_Brown", "OMNOGloves_Gray" };
			int rndIndex6 = Math.RandomInt(0, 4);
			gloves = player.GetInventory().CreateInInventory(glovesArray[rndIndex6]);
			...
			int rndIndex7 = Math.RandomInt(0, 7);
			armband = player.GetInventory().CreateInInventory(armbandArray[rndIndex7]);
			...
			itemEnt = player.GetInventory().CreateInInventory(foodArray[rndIndex8]);
			...
			//Soda aléatoire
			string foodArray[] = { "SodaCan_Cola", "SodaCan_Kvass", "SodaCan_Pipsi", "SodaCan_Spite" };
			int rndIndex9 = Math.RandomInt(0, 3);
			itemEnt = player.GetInventory().CreateInInventory(foodArray[rndIndex9]);
			...
			string smokeArray[] = { "FlashGrenade", "M18SmokeGrenade_Green", "M18SmokeGrenade_Purple", "M18SmokeGrenade_Red", "M18SmokeGrenade_White", "M18SmokeGrenade_Yellow" };
			int rndIndex10 = Math.RandomInt(0, 5);
			smoke = player.GetInventory().CreateInInventory(smokeArray[rndIndex10]);
			
				//Création de la grenade aléatoire d'attaque
			string grenadeArray[] = { "M67Grenade", "RGD5Grenade" };
			int rndIndex11 = Math.RandomInt(0, 1);
			grenade = player.GetInventory().CreateInInventory(grenadeArray[rndIndex11]);

			//Pistolet
			string pistolArray[] = { "Deagle", "Deagle_Gold", "FNX45", "Magnum" };
			int rndIndexPistol = Math.RandomInt(0, 3);
				// placé dans la ceinture
			...
			if 	(rndIndexPistol = 3){
				...
				itemEnt = pant.GetInventory().CreateInInventory("FNP45_MRDSOptic");
				itemEnt = pant.GetInventory().CreateInInventory("PistolSuppressor");
			...
			//Fusil d'assaut 
			string Array[] = { "Saiga", "M4A1", "M4A1_Black", "M4A1_Green", "AK101", "AK101_Black", "AK101_Green", "AK74", "AK74_Black", "AK74_Green", "AKM" };
			int rndIndexAssault = Math.RandomInt(0, 10);
			assault = player.GetInventory().CreateInInventory(Array[rndIndexAssault]);
